...
| [dsh-wsl-im](https://github.com/173787247/dsh-wsl-im) | 0.3.8 | 不在 `install.sh` |
...
| 方向 | 规划 | 现状 |
|------|------|------|
| 飞书 / 企微 / 钉钉 / QQ / Slack / Discord / Telegram / Mattermost | 继续深挖 [dsh-wsl-im](https://github.com/173787247/dsh-wsl-im)，**不进** `install.sh`。 | **0.3.8**；加深队列见 [`docs/ENHANCEMENT_QUEUE.zh.md`](./docs/ENHANCEMENT_QUEUE.zh.md) |
